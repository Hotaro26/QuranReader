...
public final class SettingsViewModel_Factory implements Factory<SettingsViewModel> {
  ...
  public SettingsViewModel_Factory(Provider<QuranRepository> repositoryProvider) {
  ...
  public static SettingsViewModel_Factory create(Provider<QuranRepository> repositoryProvider) {
    return new SettingsViewModel_Factory(repositoryProvider);
  }

  public static SettingsViewModel newInstance(QuranRepository repository) {
